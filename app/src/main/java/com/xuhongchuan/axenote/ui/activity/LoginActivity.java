 ...
 */
public class LoginActivity extends FragmentActivity implements IChangeTheme{
    ...
    public void changeTheme() {
        ...
        if (GlobalConfig.getInstance().isNightMode(LoginActivity.this)) {
