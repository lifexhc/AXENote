...
public class ContentActivity extends BaseActivity {
    ...
    private String filePath; // 图片路径，从SD卡获取图片时使用
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case RQ_GET_IMAGE_FROM_SD_CARD:
                    ...
                    filePath = getRealPathFromURI(this, originalUri);
                    // 根据路径从SD卡获取图片并压缩
                    final Bitmap bitmap = BitmapUtils.compressBitmap(filePath, this, 0.75F);
                    // 插入图片到数据库
